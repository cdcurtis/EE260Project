...
int main()
{
	...
	{
		cout<<i<<endl;
		LeveledDag* LDag= new LeveledDag(*startingPoint[i]);
		LDag->print();
		lg.push_back(LDag);
...
void InitalizeDAGs(vector<DagGen*>& dags)
{
	...
	Vertex * Dis1 = dag->addVertex(DISPENSE, "dg1_D1");
	Vertex * Dis2 = dag->addVertex(DISPENSE, "dg1_D2");
	Vertex * Mix = dag->addVertex(MIX, "dg1_Mix");
	Vertex * Heat = dag->addVertex(HEAT, "dg1_Heat");
	Vertex * Output = dag->addVertex(OUTPUT, "dg1_Output");
	...
	Vertex * d1_Dis1 = dag1->addVertex(DISPENSE, "dg2_D1");
	Vertex * d1_Dis2 = dag1->addVertex(DISPENSE, "dg2_D2");
	Vertex * d1_Dis3 = dag1->addVertex(DISPENSE, "dg2_D3");
	Vertex * d1_Dis4 = dag1->addVertex(DISPENSE, "dg2_D4");

	Vertex * d1_Mix = dag1->addVertex(MIX, "dg2_Mix");
	Vertex * d1_Mix2 = dag1->addVertex(MIX, "dg2_Mix2");
	Vertex * d1_Mix3 = dag1->addVertex(MIX, "dg2_Mix3");
	Vertex * d1_Detect = dag1->addVertex(DETECT, "dg2_Detect");
	Vertex * d1_Output = dag1->addVertex(OUTPUT, "dg2_Output");
